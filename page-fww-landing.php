			...
			<div class="container">
				...
				<section class="featured">
					...
					<div class="row rss-content">
						...
						<?php make_path_relative( fww_rss( 'https://blog.nationalarchives.gov.uk/blog/tag/first-world-war/feed/', '1' ) ) ?>

						<!-- Dynamically pulls the latest news item with the category first-world-war-portal-news -->
						<?php make_path_relative( fww_news_rss( 'https://www.nationalarchives.gov.uk/category/first-world-war-portal-news/feed/', '2' ) ) ?>
